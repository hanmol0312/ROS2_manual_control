...
#include "custom_msgs/msg/detail/board__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::Board & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::Board & ros_message)
{
  // Member: key_up
  cdr >> ros_message.key_up;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::msg::Board;
    is_plain =
      (
      offsetof(DataType, j) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::Board *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::Board *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Board__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, Board)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Board__handle;
}
