...
#include "custom_msgs/msg/detail/board__rosidl_typesupport_fastrtps_c.h"
...
using _Board__ros_msg_type = custom_msgs__msg__Board;
...
size_t get_serialized_size_custom_msgs__msg__Board(
  const void * untyped_ros_message,
...
static uint32_t _Board__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__Board(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__msg__Board(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__Board;
    is_plain =
      (
      offsetof(DataType, j) +
      last_member_size
...
static size_t _Board__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__Board(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, Board)() {
