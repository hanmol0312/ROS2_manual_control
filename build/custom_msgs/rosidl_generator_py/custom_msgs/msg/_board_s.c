...
bool custom_msgs__msg__board__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._board.Board", full_classname_dest, 28) == 0);
  }
  custom_msgs__msg__Board * ros_message = _ros_message;
  {  // key_up
...
PyObject * custom_msgs__msg__board__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._board");
