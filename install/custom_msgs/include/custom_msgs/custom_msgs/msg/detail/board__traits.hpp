...
#ifndef CUSTOM_MSGS__MSG__DETAIL__BOARD__TRAITS_HPP_
#define CUSTOM_MSGS__MSG__DETAIL__BOARD__TRAITS_HPP_
...
inline void to_yaml(
  const custom_msgs::msg::Board & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const custom_msgs::msg::Board & msg)
{
  return custom_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<custom_msgs::msg::Board>()
{
  return "custom_msgs::msg::Board";
}

template<>
inline const char * name<custom_msgs::msg::Board>()
{
  return "custom_msgs/msg/Board";
}

template<>
struct has_fixed_size<custom_msgs::msg::Board>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<custom_msgs::msg::Board>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<custom_msgs::msg::Board>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // CUSTOM_MSGS__MSG__DETAIL__BOARD__TRAITS_HPP_
