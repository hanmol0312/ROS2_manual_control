...
#ifndef CUSTOM_MSGS__MSG__DETAIL__BOARD__STRUCT_HPP_
#define CUSTOM_MSGS__MSG__DETAIL__BOARD__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__custom_msgs__msg__Board __attribute__((deprecated))
#else
# define DEPRECATED__custom_msgs__msg__Board __declspec(deprecated)
#endif
...
struct Board_
{
  ...
  // pointer types
  using RawPtr =
    custom_msgs::msg::Board_<ContainerAllocator> *;
  using ConstRawPtr =
    const custom_msgs::msg::Board_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<custom_msgs::msg::Board_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<custom_msgs::msg::Board_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      custom_msgs::msg::Board_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<custom_msgs::msg::Board_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<custom_msgs::msg::Board_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<custom_msgs::msg::Board_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<custom_msgs::msg::Board_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__custom_msgs__msg__Board
    std::shared_ptr<custom_msgs::msg::Board_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__custom_msgs__msg__Board
    std::shared_ptr<custom_msgs::msg::Board_<ContainerAllocator> const>
...
using Board =
  custom_msgs::msg::Board_<std::allocator<void>>;
...
#endif  // CUSTOM_MSGS__MSG__DETAIL__BOARD__STRUCT_HPP_
