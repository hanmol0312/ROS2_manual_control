    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'action_tutorials_interfaces.action.Offboard_Goal')
            logger.debug(
...
class Metaclass_Offboard_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_tutorials_interfaces.action.Offboard_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Offboard_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_tutorials_interfaces.action.Offboard_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Offboard_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from action_tutorials_interfaces.action import Offboard
...
class Offboard_SendGoal_Request(metaclass=Metaclass_Offboard_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'action_tutorials_interfaces/Offboard_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_tutorials_interfaces', 'action'], 'Offboard_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_tutorials_interfaces.action._offboard import Offboard_Goal
...
class Metaclass_Offboard_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_tutorials_interfaces.action.Offboard_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from action_tutorials_interfaces.action import _offboard
...
class Offboard_SendGoal(metaclass=Metaclass_Offboard_SendGoal):
    from action_tutorials_interfaces.action._offboard import Offboard_SendGoal_Request as Request
    from action_tutorials_interfaces.action._offboard import Offboard_SendGoal_Response as Response
...
class Offboard_GetResult_Response(metaclass=Metaclass_Offboard_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'action_tutorials_interfaces/Offboard_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_tutorials_interfaces', 'action'], 'Offboard_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_tutorials_interfaces.action._offboard import Offboard_Result
...
class Metaclass_Offboard_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_tutorials_interfaces.action.Offboard_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Offboard_GetResult(metaclass=Metaclass_Offboard_GetResult):
    from action_tutorials_interfaces.action._offboard import Offboard_GetResult_Request as Request
    from action_tutorials_interfaces.action._offboard import Offboard_GetResult_Response as Response
...
class Metaclass_Offboard_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_tutorials_interfaces.action.Offboard_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Offboard_FeedbackMessage(metaclass=Metaclass_Offboard_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'action_tutorials_interfaces/Offboard_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_tutorials_interfaces', 'action'], 'Offboard_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from action_tutorials_interfaces.action._offboard import Offboard_Feedback
...
class Metaclass_Offboard(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_tutorials_interfaces.action.Offboard')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Offboard(metaclass=Metaclass_Offboard):
    ...
    from action_tutorials_interfaces.action._offboard import Offboard_Goal as Goal
    # The result message defined in the action definition.
    from action_tutorials_interfaces.action._offboard import Offboard_Result as Result
    # The feedback message defined in the action definition.
    from action_tutorials_interfaces.action._offboard import Offboard_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from action_tutorials_interfaces.action._offboard import Offboard_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from action_tutorials_interfaces.action._offboard import Offboard_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from action_tutorials_interfaces.action._offboard import Offboard_FeedbackMessage as FeedbackMessage
